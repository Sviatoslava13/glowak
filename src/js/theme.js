document.addEventListener("DOMContentLoaded", function () {
  ...
  toggleCheckbox.addEventListener("change", function () {
    ...
    if (!toggleCheckbox.classList.contains("active")) {
      ...
      document.querySelector(".button_hero.secondary").style.backgroundColor =
        "#D4B48C";
      document.querySelector(".button_hero.tertiary").style.backgroundColor =
        "#BFA082";
      ...
      document.querySelector(".logo_header").style.backgroundColor =
        "transparent";
      ...
      document.querySelector(".certificates").style.border =
        "2px dashed #daa06d";
      document.querySelector(".certificates").style.boxShadow =
        "0 0 0 4px #eaddca, 2px 2px 4px 2px rgba(0, 0, 0, 0.5)";
      ...
      document.querySelector(".footer-logo-img").style.backgroundColor =
        "transparent";
      ...
      document.querySelector(".section_about").style.backgroundColor =
        "#1D2D44";
